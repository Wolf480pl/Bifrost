...
public class ScriptAPI implements ScriptInterface {
    ...
    private void setScript() {
        switch (this.scriptName) {
            ...
            case XF:
                ...
                break;
            case WP:
                this.script = new WordPress(this.scriptName, this.version);
                break;
        }
    }
    ...
    public CacheManager getCacheManager() {
        return Bifrost.getInstance().getCacheManager();
    }

    public Cache getCache() {
        return Bifrost.getInstance().getCache();
    }

    public DataManager getDataManager() {
        return Bifrost.getInstance().getDataManager();
    }
